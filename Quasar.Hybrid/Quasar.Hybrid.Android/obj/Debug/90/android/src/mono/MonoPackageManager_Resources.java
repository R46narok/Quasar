...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Quasar.Hybrid.Android.dll" comes first in this list. */
		"Quasar.Hybrid.Android.dll",
		"DnsClient.dll",
		"FormsViewGroup.dll",
		...
		"Quasar.Core.DataAccess.dll",
		"Quasar.Core.dll",
		"Quasar.Core.Native.dll",
		"Quasar.Hybrid.dll",
		"Quasar.Hybrid.Shared.dll",
		"SharpCompress.dll",
		"System.Buffers.dll",
